class TacticalBot_v1 (object):
    ...
    def update(self, gameInfo):
        ...
        # Get list of all planets we could attack
        not_my_planet_details = list(filter(lambda planet: planet['owner'] != 'me', planet_details.values()))
